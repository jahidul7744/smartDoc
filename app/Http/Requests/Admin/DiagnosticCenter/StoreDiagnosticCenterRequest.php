...
class StoreDiagnosticCenterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', 'regex:/^[a-z0-9-]+$/', Rule::unique('diagnostic_centers', 'slug')],
            'email' => ['nullable', 'email', 'max:255', Rule::unique('diagnostic_centers', 'email')],
            'phone' => ['nullable', 'string', 'max:50', Rule::unique('diagnostic_centers', 'phone')],
